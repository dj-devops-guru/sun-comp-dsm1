<center><img width="845" alt="Sun_Comp" src="https://suncomputers.biz/wp-content/uploads/2019/11/logo.png"></center>

SunComp is a customized Redpill Loader for DSM 7.x (Xpenology) with enhanced Hardwaresupport, Addons, Extensions, guided(semi-automated) Installation and more. Multiple customization options are built-in. It is modified to run on different Hardware (see Wiki for more Informations).
